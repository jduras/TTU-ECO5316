...
(a) Use `tq_get` to obtain the quarterly real private fixed investment (chain-type quantity index), available on FRED under code [`B007RA3Q086SBEA`](https://fred.stlouisfed.org/series/B007RA3Q086SBEA).
